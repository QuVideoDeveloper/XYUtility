...
- (instancetype)initWithController:(XYKVOListener *)listener
                           keyPath:(NSString *)keyPath
                           options:(NSKeyValueObservingOptions)options
                             block:(XYKVONotificationBlock)block
                            action:(SEL)action
...
- (instancetype)initWithController:(XYKVOListener *)listener
                           ...
                           options:(NSKeyValueObservingOptions)options
                             block:(XYKVONotificationBlock)block {
    return [self initWithController:listener
                            keyPath:keyPath
                            options:options
                              block:block
                             action:NULL
...
- (void)observe:(id)object
    ...
    // create info
    _XYKVOInfo *info = [[_XYKVOInfo alloc] initWithController:self
                                                      keyPath:keyPath
                                                      options:options
                                                        block:block];
